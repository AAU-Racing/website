<div class="nav flex-{{$flex}}-column justify-content-center nav-pills nav-pills-aau mb-3" id="v-pills-tab" aria-orientation="vertical">
    ...
    <a class="nav-link @isset($avatars) active @endisset" id="v-pills-avatars-tab" href="{{ route('admin::avatar::home') }}" aria-controls="v-pills-avatars" aria-selected="{{ isset($avatars) }}">Avatars</a>
    ...
    <a class="nav-link @isset($departments) active @endisset" id="v-pills-avatars-tab" href="{{ route('admin::department::home') }}" aria-controls="v-pills-avatars" aria-selected="{{ isset($departments) }}">Departments</a>
</div>
